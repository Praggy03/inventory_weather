...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference("Shipment.count") do
      post shipments_url, params: { shipment: { city_id: @shipment.city_id, name: @shipment.name, zipcode: @shipment.zipcode } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { city_id: @shipment.city_id, name: @shipment.name, zipcode: @shipment.zipcode } }
